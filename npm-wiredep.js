...
function wiredep(opts) {
  ...
  config.set
    ...
    ('sortedDependenciesReferenceList', Array.isArray(opts.sortedDependenciesReferenceList) ? opts.sortedDependenciesReferenceList : [ opts.sortedDependenciesReferenceList ])
